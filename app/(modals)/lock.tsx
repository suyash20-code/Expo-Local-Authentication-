...
const Page = () => {
  ...
  const numberBackSpace = (number:number) =>{
    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
  ...
  return (
    <SafeAreaView>
      <Text style={styles.gretting}>Welcome back, Suyash</Text>
      ...
      <View style={styles.numbersView}>
        ...
        <TouchableOpacity  onPress={onBiometricPress}>
          <Icon name='face-recognition' size={30} color="black"></Icon>
        </TouchableOpacity>
        ...
        <TouchableOpacity  onPress={numberBackSpace}>
          <Icon name='backspace-outline' size={30} color="black"></Icon>
        </TouchableOpacity>
          )}
        </View>
        </View>
